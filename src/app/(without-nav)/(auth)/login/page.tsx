  ...
  return (
    <>
      ...
      <div className="flex justify-center gap-16 mt-6">
        <Link href="https://boardbuddyapp.com/api/oauth/authorization/naver">
          <Image
        ...
        <Link href="https://boardbuddyapp.com/api/oauth/authorization/kakao">
          <Image
        ...
        <Link href="https://boardbuddyapp.com/api/oauth/authorization/google">
          <Image
